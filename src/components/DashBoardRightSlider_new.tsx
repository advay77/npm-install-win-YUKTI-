                    ...
                    {messages.length == 0 ? (
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button className={`p-6 rounded-xl border-2 font-sora text-xs tracking-tight text-center hover:scale-105 active:scale-95 transition-all duration-200 cursor-pointer font-semibold group ${darkTheme
